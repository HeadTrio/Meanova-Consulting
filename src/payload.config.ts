...
export default buildConfig({
  serverURL: 'https://meanova-consulting.vercel.app',
  admin: {
    user: Users.slug,
    importMap: {
  ...
  plugins: [
     vercelBlobStorage({
      ...
      token: process.env.BLOB_READ_WRITE_TOKEN || "vercel_blob_rw_BV0rLb0oACmGdku1_zgwv1Raht7VMNzXhUUiJKxBAkVIPjB", // Set in Vercel env
    }),
  ],
})
